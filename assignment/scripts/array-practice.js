...
foodArray[1] = 'burritos'
console.log(foodArray);
// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
foodArray.sort()
let sortedFood = foodArray.reverse()
console.log(sortedFood)
// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.
console.log('My favorite foods are ' + foodArray[0] + ' and ' + foodArray[1] + ' and ' + foodArray[2] + ' and ' + foodArray[3] + '.');
// 4.h (STRETCH) TODO: Make a new array that combines 
//     the favorite foods array with the animals array.
//     Then log the new array.
//     It should look something like:
//     ['pizza', 'pasta', 'fish', 'cat', 'bird', 'dog']
const array3 = foodArray.concat(animalArray);
console.log(array3);